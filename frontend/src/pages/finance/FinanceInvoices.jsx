  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KartuAngka label="Invoice Ditampilkan" value={r?.total ?? 0} sub="Sesuai filter" />
        <KartuAngka
      ...
      <Card className="overflow-hidden">
        <CardHeader>
          <CardTitle>{invoices.length} invoice</CardTitle>
          <CardDescription>
            Invoice gabungan tampil sebagai SATU baris (dokumen yang benar-benar dikirim ke customer adalah
