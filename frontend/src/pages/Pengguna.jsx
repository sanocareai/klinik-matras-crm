...
export default function Pengguna({ user }) {
  if (user?.role !== "ADMIN") {
    return (
  ...
  return (
    <div className="page" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", textAlign: "center" }}>
      <UserCog size={48} color="#d1d5db" style={{ marginBottom: 16 }} />
      <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: "var(--text-main)" }}>Pengguna &amp; Peran</h2>
      <p style={{ margin: "8px 0 0", color: "var(--text-muted)", fontSize: 14 }}>
