    ...
    <View style={styles.container}>
      ...
      {isAdmin ? (
        <>
          ...
          {/* Revisi 28 Jul 2026: kartu kedua "Total Nilai Order Bulan Ini"
              (semua order, termasuk yang belum ada sales-nya) DIHAPUS —
              2 angka besar berdampingan yang definisinya beda justru bikin
              bingung, bukan memperjelas. Cukup SATU angka di kartu hero atas.
              Angka "Target Tim" itu memang sudah sinkron dengan CRM web:
              keduanya membaca endpoint yang SAMA (GET /analytics/
              sales-performance) dan dipakai widget yang sama di web
              (frontend/src/features/dashboard/components/TargetSalesWidget.jsx),
              jadi tidak perlu angka pembanding kedua di sini. */}
