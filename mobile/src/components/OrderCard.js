...
function createStyles(tokens) {
  ...
  editBtn: { ...tokens.glass.surface, borderWidth: 1, borderColor: tokens.color.border, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 },
  ...
  chip: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 16, borderWidth: 1, borderColor: tokens.color.border, ...tokens.glass.surface },
  chipText: { fontSize: 11, fontWeight: "600", color: tokens.color.textSecondary },
  input: { ...tokens.glass.surface, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, fontSize: 13, color: tokens.color.textPrimary },
